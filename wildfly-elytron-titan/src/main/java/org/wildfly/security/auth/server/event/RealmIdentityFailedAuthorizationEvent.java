...
public final class RealmIdentityFailedAuthorizationEvent extends RealmIdentityAuthorizationEvent {
     ...
     * @param newPrincipal the authorize-as principal
     */
    public RealmIdentityFailedAuthorizationEvent(final AuthorizationIdentity authorizationIdentity, final Principal principal, final Principal newPrincipal) {
        super(authorizationIdentity, principal, newPrincipal);
    }

    public <P, R> R accept(final RealmEventVisitor<P, R> visitor, final P param) {
        return visitor.handleIdentityFailedAuthorizationEvent(this, param);
    }
