...
public class PersistentNonceManager extends NonceManager implements Serializable {
    ...
    /**
     * Update attributes from provided PersistentNonceManager to this instance
     *
    ...
    void refreshInfoFromSessionNonceManager(PersistentNonceManager persistentNonceManager) {
        this.validityPeriodNano = persistentNonceManager.getValidityPeriodNano();
        this.nonceSessionTime = persistentNonceManager.getNonceSessionTime();
        this.algorithm = persistentNonceManager.getAlgorithm();
        this.nonceCounter = persistentNonceManager.getNonceCounter();
        this.usedNonces = persistentNonceManager.getUsedNonces();
        this.privateKey = persistentNonceManager.getPrivateKey();
        this.singleUse = persistentNonceManager.isSingleUse();
    }
}
