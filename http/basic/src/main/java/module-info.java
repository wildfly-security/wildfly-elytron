module org.wildfly.security.http.basic {
    ...
    exports org.wildfly.security.http.basic;

    provides java.security.Provider
        with org.wildfly.security.http.basic.WildFlyElytronHttpBasicProvider;
    provides org.wildfly.security.http.HttpServerAuthenticationMechanismFactory
        with org.wildfly.security.http.basic.BasicMechanismFactory;
}
