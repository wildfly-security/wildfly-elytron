...
public class KeycloakConfiguration {
     ...
     * <ul>
     * <li>Realm called WildFly</li>
     * <li>Client named simple-webapp</li>
     ...
     * </ul>
     */
    public static RealmRepresentation getRealmRepresentation(final String realmName) {
        return createRealm(realmName);
    }
    ...
    private static RealmRepresentation createRealm(String name) {
        ...
        realm.getClients().add(createWebAppClient(CLIENT_ID, CLIENT_SECRET));
    ...
    private static ClientRepresentation createWebAppClient(String clientId, String clientSecret) {
