...
public class OidcProviderMetadata {
    ...
    private List<String> requestObjectContentEncryptionMethodsSupported;
    ...
    public void setRequestObjectContentEncryptionMethodsSupported(List<String> requestObjectContentEncryptionMethodsSupported) {
