...
public final class WildFlyElytronHttpBasicProvider extends WildFlyElytronBaseProvider {
    ...
    public WildFlyElytronHttpBasicProvider() {
        ...
        putService(new ProviderService(this, HTTP_SERVER_FACTORY_TYPE, "STATEFUL_BASIC", "org.wildfly.security.http.basic.BasicMechanismFactory", emptyList, emptyMap, true, true));
    }
