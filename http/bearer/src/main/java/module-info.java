module org.wildfly.security.http.bearer {
    ...
    exports org.wildfly.security.http.bearer;

    provides java.security.Provider
        with org.wildfly.security.http.bearer.WildFlyElytronHttpBearerProvider;
    provides org.wildfly.security.http.HttpServerAuthenticationMechanismFactory
        with org.wildfly.security.http.bearer.BearerMechanismFactory;
}
