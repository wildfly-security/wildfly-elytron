 ...
 * </ul>
 *
 * @apiNote This class is mirrored by {@code SSLContextBuilder} in module {@code wildfly-elytron-ssl}; both
 * classes should always be modified together.
 * @author <a href="mailto:david.lloyd@redhat.com">David M. Lloyd</a>
 */
public final class BaseSSLContextBuilder {
     ...
     */
    public BaseSSLContextBuilder setCipherSuiteSelector(final CipherSuiteSelector cipherSuiteSelector) {
     ...
     */
    public BaseSSLContextBuilder setProtocolSelector(final ProtocolSelector protocolSelector) {
     ...
     */
    public BaseSSLContextBuilder setUseCipherSuitesOrder(final boolean useCipherSuitesOrder) {
     ...
     */
    public BaseSSLContextBuilder setWantClientAuth(final boolean wantClientAuth) {
     ...
     */
    public BaseSSLContextBuilder setNeedClientAuth(final boolean needClientAuth) {
     ...
     */
    public BaseSSLContextBuilder setAuthenticationOptional(final boolean authenticationOptional) {
     ...
     * @return The {@link BaseSSLContextBuilder} to allow chaining of method calls.
     */
    public BaseSSLContextBuilder setSessionCacheSize(final int sessionCacheSize) {
     ...
     * @return The {@link BaseSSLContextBuilder} to allow chaining of method calls.
     */
    public BaseSSLContextBuilder setSessionTimeout(final int sessionTimeout) {
     ...
     */
    public BaseSSLContextBuilder setKeyManagerSecurityFactory(final SecurityFactory<X509ExtendedKeyManager> keyManagerSecurityFactory) {
     ...
     */
    public BaseSSLContextBuilder setKeyManager(final X509ExtendedKeyManager keyManager) {
     ...
     */
    public BaseSSLContextBuilder setTrustManagerSecurityFactory(final SecurityFactory<X509TrustManager> trustManagerSecurityFactory) {
     ...
     */
    public BaseSSLContextBuilder setTrustManager(final X509TrustManager trustManager) {
     ...
     */
    public BaseSSLContextBuilder setProviderSupplier(final Supplier<Provider[]> providerSupplier) {
     ...
     * @return this builder
     */
    public BaseSSLContextBuilder setProviderName(final String name) {
     ...
     * @return this builder
     */
    public BaseSSLContextBuilder setClientMode(final boolean clientMode) {
     ...
     * @return this builder
     */
    public BaseSSLContextBuilder setWrap(final boolean wrap) {
        this.wrap = wrap;
        return this;
    }
    ...
    public SecurityFactory<SSLContext> build() {
        ...
        return new OneTimeSecurityFactory<>(() -> {
            ...
            if (BaseElytronMessages.tls.isTraceEnabled()) {
                BaseElytronMessages.tls.tracef("SSLContext initialization (no security domain):%n" +
                                ...
                                "    wrap = %s%n",
                        cipherSuiteSelector, protocolSelector, x509TrustManager,
            ...
            final SSLConfigurator sslConfigurator = clientMode ?
                    ...
                    new SSLConfiguratorImpl(protocolSelector, cipherSuiteSelector, wantClientAuth, needClientAuth, useCipherSuitesOrder);
