 ...
 */
public final class DomainlessSSLContextBuilder {
     ...
     */
    public DomainlessSSLContextBuilder setCipherSuiteSelector(final CipherSuiteSelector cipherSuiteSelector) {
     ...
     */
    public DomainlessSSLContextBuilder setProtocolSelector(final ProtocolSelector protocolSelector) {
     ...
     */
    public DomainlessSSLContextBuilder setUseCipherSuitesOrder(final boolean useCipherSuitesOrder) {
     ...
     */
    public DomainlessSSLContextBuilder setWantClientAuth(final boolean wantClientAuth) {
     ...
     */
    public DomainlessSSLContextBuilder setNeedClientAuth(final boolean needClientAuth) {
     ...
     */
    public DomainlessSSLContextBuilder setAuthenticationOptional(final boolean authenticationOptional) {
     ...
     * @return The {@link DomainlessSSLContextBuilder} to allow chaining of method calls.
     */
    public DomainlessSSLContextBuilder setSessionCacheSize(final int sessionCacheSize) {
     ...
     * @return The {@link DomainlessSSLContextBuilder} to allow chaining of method calls.
     */
    public DomainlessSSLContextBuilder setSessionTimeout(final int sessionTimeout) {
     ...
     */
    public DomainlessSSLContextBuilder setKeyManagerSecurityFactory(final SecurityFactory<X509ExtendedKeyManager> keyManagerSecurityFactory) {
     ...
     */
    public DomainlessSSLContextBuilder setKeyManager(final X509ExtendedKeyManager keyManager) {
     ...
     */
    public DomainlessSSLContextBuilder setTrustManagerSecurityFactory(final SecurityFactory<X509TrustManager> trustManagerSecurityFactory) {
     ...
     */
    public DomainlessSSLContextBuilder setTrustManager(final X509TrustManager trustManager) {
     ...
     */
    public DomainlessSSLContextBuilder setProviderSupplier(final Supplier<Provider[]> providerSupplier) {
     ...
     * @return this builder
     */
    public DomainlessSSLContextBuilder setProviderName(final String name) {
     ...
     * @return this builder
     */
    public DomainlessSSLContextBuilder setClientMode(final boolean clientMode) {
     ...
     * @return this builder
     */
    public DomainlessSSLContextBuilder setWrap(final boolean wrap) {
        this.wrap = wrap;
        return this;
    }
    ...
    public SecurityFactory<SSLContext> build() {
        ...
        return new OneTimeSecurityFactory<>(() -> {
            ...
            if (ElytronMessages.tls.isTraceEnabled()) {
                ElytronMessages.tls.tracef("Domainless SSLContext initialization:%n" +
