 ...
 * </ul>
 *
 * @apiNote This class mirrors and extends {@code BaseSSLContextBuilder} in module {@code wildfly-elytron-ssl-base};
 * both classes should always be modified together.
