...
https://hacktoberfest.com/[Hacktoberfest] takes place annually during the month of October. This event encourages open source contributions from the community. To participate in Hacktoberfest, you simply need to:
...
3. You’ll unlock a digital badge when you register for Hacktoberfest, and level it up with each of your four pull/merge requests accepted during Hacktoberfest. Visit the https://hacktoberfest.com/particfdipation/[Hacktoberfest site] for more information.

== Getting Started

To get started, follow the steps below:

. *Create a Jira Account.* Visit https://issues.redhat.com/[] and click on *Log In* in the top right corner of the page.
...
+
++++
{#include partials/OSD-2022-logo-bullets.html}
++++
...
* link:../getting-started-for-developers/#getting-your-developer-environment-set-up[Building and testsuite commands]
