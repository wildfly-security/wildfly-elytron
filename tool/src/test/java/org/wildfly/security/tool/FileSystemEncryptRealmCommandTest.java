...
public class FileSystemEncryptRealmCommandTest extends AbstractCommandTest{
    ...
    private void runCommand(String inputLocation, String outputLocation, String fileSystemRealmName, int expectedStatus) {
        String[] requiredArgs;
    ...
    private void runCommand(String inputLocation, String outputLocation, String fileSystemRealmName, String credentialStore, String secretKey, int expectedStatus) {
        String[] requiredArgs;
        requiredArgs = new String[]{"--input-location", inputLocation, "--output-location", outputLocation, "--realm-name", fileSystemRealmName, "--credential-store", credentialStore, "--secret-key", secretKey};
        executeCommandAndCheckStatus(requiredArgs, expectedStatus);
    }
    ...
    public void testSingleUser() throws Exception {
        ...
        runCommand(inputLocation, outputLocation, fileSystemRealmName, 0);
    ...
    public void testSingleUserWithRoles() throws Exception {
        ...
        runCommand(inputLocation, outputLocation, fileSystemRealmName, 0);
        String file = "target/test-classes/filesystem-encrypt/fs-encrypted-realms/single-user-with-role/O/B/OBSXE43PNYYTEMY.xml";
        if(!fileExists(file)){
            throw new FileNotFoundException("Missing file: " + file);
        } else {
            System.out.println("Found file: " + file);
    ...
    public void testSingleUserWithRolesAndKey() throws Exception {
        ...
        String key = "key";
        runCommand(inputLocation, outputLocation, fileSystemRealmName, credentialStore, key, 0);
