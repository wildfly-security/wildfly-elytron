...
/**
 * Interface to implement when one needs own {@link Callback} get handled by {@code VaultManager}.
 *
 * Workflow:
 * <ol>
 ...
 *     <li>{@code VaultManager} gathers parameters from configuration and calls {@link ParametrizedCallback#initialize(String[])}</li>
 ...
 *     <li>{@code VaultManager} reads password using method {@link ParametrizedCallback#getPassword()}</li>
 *     <li>{@code VaultManager} destroys password in the callback using method {@link ParametrizedCallback#destroy()}. Implement this method as well.</li>
 * </ol>
 *
 * @author <a href="mailto:pskopek@redhat.com">Peter Skopek</a>.
 * @see ParametrizedCallbackHandler
 */
public interface ParametrizedCallback extends Callback, Destroyable {
    /**
