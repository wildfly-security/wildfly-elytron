...
public final class DigestMD5Server extends DigestMD5Base implements SaslServer {
    ...
    private static final Logger log = Logger.getLogger("org.wildfly.sasl.digest.server");
    ...
    private static final String ALTERNATIVE_PROTOCOLS_PROPERTY = "org.wildfly.sasl.digest.alternative_protocols";
    private static final String LEGACY_ALTERNATIVE_PROTOCOLS_PROPERTY = "org.jboss.sasl.digest.alternative_protocols";
    ...
    DigestMD5Server(String protocol, String serverName, Map<String, ?> props, CallbackHandler cbh) throws SaslException {
        ...
        if (props != null) {
            ...
            if (props.containsKey(ALTERNATIVE_PROTOCOLS_PROPERTY)) {
                protocols = (String) props.get(ALTERNATIVE_PROTOCOLS_PROPERTY);
            } else if (props.containsKey(LEGACY_ALTERNATIVE_PROTOCOLS_PROPERTY)) {
                protocols = (String) props.get(LEGACY_ALTERNATIVE_PROTOCOLS_PROPERTY);
            }
            if (protocols != null) {
