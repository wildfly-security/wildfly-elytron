...
public class NoServerAuthTest extends AbstractTest {
    ...
    public void testAuth() throws Exception {
        ...
        assertEquals("603f06092a864886f71201020202010400ffffffff80915a616fd894e990988f98310c7201c6a514024aa8df9f3f6633bb92c6ef6a6fe3d30d0100000004040404", ByteIterator.ofBytes(exchange).hexEncode().drainToString());
        assertFalse(server.isComplete());
        assertFalse(client.isComplete());

        exchange = evaluateByClient(exchange);
        assertEquals("603f06092a864886f71201020202010400fffffffffca2f8113c0f684a00202ed5beeead5ed8b87b91d41e1d5ff9c287584c916a5de687fe8b0100000004040404", ByteIterator.ofBytes(exchange).hexEncode().drainToString());
        assertFalse(server.isComplete());
