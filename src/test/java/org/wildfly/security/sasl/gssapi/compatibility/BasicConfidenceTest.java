...
public class BasicConfidenceTest extends AbstractTest {
    ...
    public void testAuthConf() throws Exception {
        ...
        exchange = evaluateByServer(exchange);
        assertEquals("603f06092a864886f71201020202010400ffffffffab61b13cfac8213169356a532e397d047b0676bc904df3243112f7e2e687fe8bc940ea4a0400fb4104040404", ByteIterator.ofBytes(exchange).hexEncode().drainToString());
        assertFalse(server.isComplete());
        assertFalse(client.isComplete());

        exchange = evaluateByClient(exchange);
        assertEquals("603f06092a864886f71201020202010400ffffffff3bb2a4e5ea08fcd854324a5274790eeb0ea3f6882ca0e2f238726db69cd068a60d1fd2ad0400ef3204040404", ByteIterator.ofBytes(exchange).hexEncode().drainToString());
        assertFalse(server.isComplete());
        ...
        assertEquals("604706092a864886f712010202020104000200ffff48536b8eaaf1e8c7566a9c44ee529bb7df24ef5a4478a7674fcb2e7997dc5ad9d13dd4a211b55ab46aced1aa69584f94bebaf5e9", ByteIterator.ofBytes(wrappedMessage).hexEncode().drainToString());
        ...
        assertEquals("604706092a864886f712010202020104000200ffff8a59850f53d842bc0166f258fe49a57c80e116bd16e63b51d2efc1a3b4ac9171284c4a18b62c76c82c1d3f5a85fda0089fc73824", ByteIterator.ofBytes(wrappedMessage).hexEncode().drainToString());
