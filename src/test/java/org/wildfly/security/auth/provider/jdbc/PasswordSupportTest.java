...
public class PasswordSupportTest {
    ...
    public void testVerifyAndObtainClearPasswordCredential() throws Exception {
        ...
        assertEquals(SupportLevel.POSSIBLY_SUPPORTED, securityRealm.getCredentialSupport("cred1"));

        RealmIdentity realmIdentity = securityRealm.createRealmIdentity(userName);

        assertEquals(SupportLevel.SUPPORTED, realmIdentity.getCredentialSupport("cred1"));
    ...
    public void testVerifyAndObtainBCryptPasswordCredentialUsingModularCrypt() throws Exception {
        ...
        assertEquals(SupportLevel.POSSIBLY_SUPPORTED, securityRealm.getCredentialSupport("cred2"));

        RealmIdentity realmIdentity = securityRealm.createRealmIdentity(userName);

        assertEquals(SupportLevel.SUPPORTED, realmIdentity.getCredentialSupport("cred2"));
    ...
    public void testVerifyAndObtainBCryptPasswordCredential() throws Exception {
        ...
        assertEquals(SupportLevel.POSSIBLY_SUPPORTED, securityRealm.getCredentialSupport("cred3"));

        RealmIdentity realmIdentity = securityRealm.createRealmIdentity(userName);

        assertEquals(SupportLevel.SUPPORTED, realmIdentity.getCredentialSupport("cred3"));
    ...
    public void assertVerifyAndObtainSaltedDigestPasswordCredential(String algorithm) throws Exception {
        ...
        assertEquals(SupportLevel.POSSIBLY_SUPPORTED, securityRealm.getCredentialSupport("cred4"));

        RealmIdentity realmIdentity = securityRealm.createRealmIdentity(userName);

        assertEquals(SupportLevel.SUPPORTED, realmIdentity.getCredentialSupport("cred4"));
    ...
    public void assertVerifyAndObtainSimpleDigestPasswordSHA512Credential(String algorithm) throws Exception {
        ...
        assertEquals(SupportLevel.POSSIBLY_SUPPORTED, securityRealm.getCredentialSupport("cred5"));

        RealmIdentity realmIdentity = securityRealm.createRealmIdentity(userName);

        assertEquals(SupportLevel.SUPPORTED, realmIdentity.getCredentialSupport("cred5"));
    ...
    public void testVerifyAndObtainScramDigestPasswordCredential() throws Exception {
        ...
        assertEquals(SupportLevel.POSSIBLY_SUPPORTED, securityRealm.getCredentialSupport("cred6"));

        RealmIdentity realmIdentity = securityRealm.createRealmIdentity(userName);

        assertEquals(SupportLevel.SUPPORTED, realmIdentity.getCredentialSupport("cred6"));
