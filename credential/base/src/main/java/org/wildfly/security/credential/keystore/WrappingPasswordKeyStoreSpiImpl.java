...
package org.wildfly.security.credential.keystore;
...
final class WrappingPasswordKeyStoreSpiImpl extends KeyStoreSpi {
    ...
    private static SecretKey encoded(final Password password) throws InvalidKeyException {
        if (password instanceof ClearPassword) {
            ...
            throw org.wildfly.security.keystore.ElytronMessages.log.invalidKeyUnknownUnknownPasswordTypeOrAlgorithm();
        }
    }
}
