...
https://wildfly-security.github.io/wildfly-elytron/blog/ws-elytron-client-integration/[blog post] to see how WS client
can make use of Elytron client configuration.
